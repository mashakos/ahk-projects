...
SetTitleMatchMode, 1
WinWaitActive, ahk_class eHome Render Window
WinMove, ahk_class eHome Render Window,, 50, 50
WinMove, ahk_class eHome Render Window,, , , A_screenWidth-50, A_screenHeight-50

sleep, 1000

if !IsFullscreen(ahk_class eHome Render Window) 
{
	Send, !{Enter}
	sleep, 2000
	Send, !{Enter}
